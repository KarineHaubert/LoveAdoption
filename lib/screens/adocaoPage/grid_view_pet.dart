...
import 'package:loveadoption/screens/adocaoPage/details.dart';
...
class GetPets extends StatefulWidget {
  ...
  @override
  _GetPetsState createState() => _GetPetsState();
}
...
class _GetPetsState extends State<GetPets> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<CadastroPet>>(
        future: _cadastroPetService.getPetbyTipo(widget.petTipo),
            ...
            return Center(
              child: Column(
                children: [
                  ...
                  Text('Ops... não há nada para ver aqui.',
                  style: TextStyle(
